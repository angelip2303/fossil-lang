...
use fossil_lang::ast::thir::{Polytype, Type as ThirType, TypeKind as ThirTypeKind, TypeVar, TypedHir};
...
impl FunctionImpl for SqlQueryFunction {
    fn signature(
        ...
        let string_ty = thir.types.alloc(ThirType {
            loc: Loc::generated(),
            kind: ThirTypeKind::Primitive(fossil_lang::ast::ast::PrimitiveType::String),
        });
        ...
        let fn_ty = thir.types.alloc(ThirType {
            loc: Loc::generated(),
            kind: ThirTypeKind::Function(vec![string_ty], result_ty),
        });
