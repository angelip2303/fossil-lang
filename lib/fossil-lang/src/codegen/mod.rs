...
//! - `RelationalQuery` (backend-independent relational algebra IR)
...
pub use rq::{
    ColId, EmissionDecl, JoinKind, LogicalType, OutputDecl, RelationalQuery, RqExpr, RqFn,
    RqLiteral, ScanSource, TableId, Transform,
};
