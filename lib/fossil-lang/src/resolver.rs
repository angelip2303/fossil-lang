//! Path resolution for data sources.
//!
//! `ResolvedPath` wraps a URL + optional cloud credentials, used by the host
//! (keasy) to resolve `@connection/path` references to actual storage URLs.
